        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-2 border rounded-md focus:ring-[#1e3a8a] focus:border-[#1e3a8a] outline-none"
              required 
            />
          </div>
          <div>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-[#1e3a8a] text-white py-2 rounded-md hover:bg-[#0f172a] transition-colors font-bold disabled:opacity-50"
          >
